...
export function watchDeep<T extends MultiWatchSources, Immediate extends Readonly<boolean> = false>(
  sources: [...T],
  cb: WatchCallback<MapSources<T, false>, MapSources<T, Immediate>>,
  options?: Omit<WatchOptions<Immediate>, 'deep'>
): WatchStopHandle;

export function watchDeep<T extends Readonly<MultiWatchSources>, Immediate extends Readonly<boolean> = false>(
  source: T,
  cb: WatchCallback<MapSources<T, false>, MapSources<T, Immediate>>,
  options?: Omit<WatchOptions<Immediate>, 'deep'>
): WatchStopHandle;
...
export function watchDeep<T extends object, Immediate extends Readonly<boolean> = false>(
  source: T,
  cb: WatchCallback<T, Immediate extends true ? T | undefined : T>,
  options?: Omit<WatchOptions<Immediate>, 'deep'>
): WatchStopHandle;
...
export function watchImmediateDeep<T extends MultiWatchSources>(
  sources: [...T],
  cb: WatchCallback<MapSources<T, true>, MapSources<T, true>>,
  options?: Omit<WatchOptions, 'immediate' | 'deep'>
): WatchStopHandle;

export function watchImmediateDeep<T extends Readonly<MultiWatchSources>>(
  source: T,
  cb: WatchCallback<MapSources<T, true>, MapSources<T, true>>,
  options?: Omit<WatchOptions, 'immediate' | 'deep'>
): WatchStopHandle;

export function watchImmediateDeep<T>(
  source: WatchSource<T>,
  cb: WatchCallback<T, true>,
  options?: Omit<WatchOptions, 'immediate' | 'deep'>
): WatchStopHandle;

export function watchImmediateDeep<T extends object>(
  source: T,
  cb: WatchCallback<T, true>,
  options?: Omit<WatchOptions, 'immediate' | 'deep'>
): WatchStopHandle;
